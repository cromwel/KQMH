...
public class LoginEx extends AppCompatActivity {
    ...
    private void login(final String encoded) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, UrlConstants.LOGIN_URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                finishLogin();
                Toast.makeText(LoginEx.this, "Successfull", Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof AuthFailureError) {
                    Toast.makeText(LoginEx.this, "Wrong email and password combination", Toast.LENGTH_SHORT).show();
                }
                closeProgressbar();
                Toast.makeText(LoginEx.this, "Cannot Log in at this time", Toast.LENGTH_SHORT).show();
