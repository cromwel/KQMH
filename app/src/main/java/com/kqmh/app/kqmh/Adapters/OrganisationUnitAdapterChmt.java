...
public class OrganisationUnitAdapterChmt extends ArrayAdapter<OrganisationUnit> {
    private Context context;
    private List<OrganisationUnit> organisationUnits = new ArrayList<>();


    public OrganisationUnitAdapterChmt(@NonNull Context context, int resource) {
    ...
    public OrganisationUnitAdapterChmt(@NonNull Context context, int resource, List<String> organisationUnits) {
        super(context, resource);
        this.context = context;
        this.organisationUnits = SQLite.select()
                .from(OrganisationUnit.class)
